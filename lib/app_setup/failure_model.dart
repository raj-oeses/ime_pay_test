...
extension DioErrorExtension on DioError {
  ...
  Failure get toFailure {
    ...
    final isDataList = data?[data.keys.first] is List?;
    final m = isDataList
        ? (data?[data.keys.first].first as String?)
        : data?[data.keys.first] as String?;
...
class FailureType {
  ...
  /// Response time out [code] : 401
  static const FailureType unAuthorized = FailureType._internal(401);
